      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <img src="build/images/BankGO.png" width="39%">
          <h2 style="font-size: 18px; font-weight: 200;color: #26b99a;">AMANAH</h2>
          <h2 style="font-size: 18px; font-weight: 200; color: #26b99a;">TERPERCAYA DAN SYARIAH</h2>
            <form action="cek_login.php" method="post">
              ...
              <div>
                <button type="submit" class="btn btn-success btn-sm btn-block">Masuk</button></form>
                 ...
                 <p>Copyright © 2021 Fahmi Aji Wicaksono.All rights reserved.</p>
                </div>
              </div>
          </section>
        </div>
